<div id="create" class="row justify-content-start align-items-center g-2" style="display: none;">
    ...
    <div class="col-md-12">
        <form name="create-sparepar-form" id="create-sparepart-form" method="post" action="{{route('storeAsset')}}"  enctype="multipart/form-data">
            @csrf
            ...
            <label for="image" class="form-label txt-blue">Upload Image</label>
            <input class="form-control" type="file" id="image" name="image" multiple />
            <div class="form-check">
              <input class="form-check-input" type="checkbox" name="usePlaceholder" id="flexCheckDefault" data-target="formFileMultiple">
